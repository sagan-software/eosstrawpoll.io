...
for contract_name in $contract_names; do
    ...
    eosiocpp --genabi $DIST_DIR/$contract_name.abi $eos_src_dir/$contract_name.cpp
    eosiocpp --outname $DIST_DIR/$contract_name.wast $eos_src_dir/$contract_name.cpp

    cp $DIST_DIR/$contract_name.* $eos_src_dir
    cp $DIST_DIR/$contract_name.* $eos_build_dir
done
